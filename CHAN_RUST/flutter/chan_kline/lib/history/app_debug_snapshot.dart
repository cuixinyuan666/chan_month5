...
class AppDebugSnapshot {
  static String build({
    ...
    buf.writeln(
      ...
      '主图指标「K(n)连续中枢」（只画框不标字），全层同构、独立色系。',
    );
    buf.writeln(
