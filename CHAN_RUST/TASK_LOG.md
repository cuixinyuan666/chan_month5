## 2026-09-05 策略跨层指标 AND/OR：同一根 K0 刚发生
...
## 2026-09-04 策略同一根K可拼 + 走完太极正中 + 价签叠筹码
...
## 2026-09-03 笔数分布才弹笔数为 0；走完太极独立转
...
## 2026-09-03 阴阳鱼正圆 + 走完小太极 + 有成交不再误报缺数据
...
## 2026-09-03 策略回测工作台下移避开标题栏 + 关闭整块台子
...
## 2026-09-03 左右分栏 / 默认一类买卖 / 当根事件跨层 / 策略点跟柱
...
## 2026-09-02 策略一类/二类/N类买卖点可跨层 AND/OR
...
## 2026-09-01 P0 信赖闸门：走完=单步 / 走完有进度 / 库版本停机 / 演示默认关
...
## 2026-08-31 分笔加载太极 + 十字信息框不挡跟手 + 主副图钮降亮
...
## 2026-08-31 当步仓：十字/步退禁止末态裁 x、禁止整段重放
...
## 2026-08-20 策略回测变量补全：未确认中枢 + 已算好指标
...
## 2026-09-05 策略买卖点形状 / N类BS填N / 指标单击 / 设置按钮
